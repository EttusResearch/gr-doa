...
class run_MUSIC_lin_array(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "run_MUSIC_lin_array")
...
def main(top_block_cls=run_MUSIC_lin_array, options=None):

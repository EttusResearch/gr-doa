...
class run_MUSIC_calib_lin_array(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "run_MUSIC_calib_lin_array", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("run_MUSIC_calib_lin_array")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "run_MUSIC_calib_lin_array")
        ...
        self.input_variables = input_variables = struct({
            ...
            'AntennaCalibration': "calibration_lin_array_245.cfg",
        ...
        self.connect((self.doa_find_local_max_0, 1), (self.qtgui_number_sink_1, 0))
        self.connect((self.doa_x440_usrp_source_0, 3), (self.doa_antenna_correction_0, 3))
        self.connect((self.doa_x440_usrp_source_0, 0), (self.doa_antenna_correction_0, 0))
        self.connect((self.doa_x440_usrp_source_0, 1), (self.doa_antenna_correction_0, 1))
        self.connect((self.doa_x440_usrp_source_0, 2), (self.doa_antenna_correction_0, 2))
...
def main(top_block_cls=run_MUSIC_calib_lin_array, options=None):

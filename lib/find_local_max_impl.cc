...
namespace gr {
    namespace doa {
        ...
        {
            return gnuradio::make_block_sptr<find_local_max_impl>(num_max_vals, vector_len, x_min, x_max);
        }
        ...
        */
        ...
        : gr::sync_block("find_local_max",
                gr::io_signature::make(1, 1, sizeof(input_type)*vector_len),
                gr::io_signature::make2(2, 2, num_max_vals*sizeof(output_type), num_max_vals*sizeof(output_type))),
        ...
        */
        ...
        void find_local_max_impl::find_more_than_one_local_peak_indxs(uvec &pk_indxs, const fvec in_vec, const int d_num_max_vals)
        {
                                    ...
                                    gr_vector_void_star& output_items)
        {
            ...
            output_type *out1 = (output_type *) output_items[0];
            output_type *out2 = (output_type *) output_items[1];
